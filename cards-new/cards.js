const students = [
  ...
  for (let student of students) {
    ...
    studentInfo.classList.add('studentInfo')
      $(studentInfo).append("<div class='studentTitle'>" + student.name + "<br>" + "Age: " + student.age +"<br>" +"</div>");
      for (let subject of student.subjects) {
        $(studentInfo).append("<div class='studentBody'>"+"<b>"+subject.name+":</b> "+subject.score+"</div>")
        $("#student-list").append(studentInfo)
